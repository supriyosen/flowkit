...
export const components: ComponentEntry[] = [
  ...
  {
    id: 'sales-report-cards',
    slug: 'sales-report-cards',
    name: 'Sales Report Cards',
    description: 'Three dark gradient sales cards with animated candlestick chart, segmented progress bars, and a 3D bar chart — all with smooth entrance and hover effects.',
    longDescription: 'A trio of premium dark-gradient sales report cards, each showcasing a different animated data visualization: a candlestick chart with staggered wick and body animations, segmented horizontal progress bars that fill from left to right, and a 3D-style bar chart with extruded depth. Every card features smooth entrance animations, a pulsing percentage indicator, animated number counter, and a lift-glow hover effect.',
    tags: ['cards', 'sales', 'finance', 'charts', 'dark', 'animated', 'gradient', 'dashboard', 'candlestick', 'bar-chart', 'data', 'widget', 'hover', 'glow'],
    category: 'Widget',
    complexity: 'medium',
    featured: true,
    gradient: 'linear-gradient(135deg, #060e08 0%, #0a1a0c 50%, #060e08 100%)',
    accentColor: '#34d399',
    createdAt: '2026-03-23',
    previewScale: 0.42,
  },
