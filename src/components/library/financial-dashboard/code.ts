export const financialDashboardCode = `'use client';
    ...
    <div ref={ref} style={{ display: 'flex', alignItems: 'flex-end', gap: 4, height: 80 }}>
      {bars.map((h, i) => (
        <motion.div
          ...
          style={{
            flex: 1,
            background: 'linear-gradient(to top, #34d399, #34d39966)',
  ...
  return (
    <div ref={containerRef} style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr 1fr', gap: 12, marginBottom: 12 }}>
        ...
        <motion.div
          custom={0} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            position: 'relative',
        ...
        {/* Axiom Capital Card */}
        <motion.div
          custom={1} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
        ...
        {/* Retail Min Card */}
        <motion.div
          custom={2} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: 12 }}>
        ...
        {/* Bar Chart */}
        <motion.div
          custom={3} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
        ...
        >
          <p style={{ fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: 4 }}>
        ...
        {/* Liquidity Velocity */}
        <motion.div
          custom={4} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
        ...
        >
          <p style={{ fontSize: 9, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: 8 }}>
            Liquidity Velocity
          </p>
        ...
        {/* Base Yield Rate */}
        <motion.div
          custom={5} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, marginBottom: 8 }}>
            <div style={{ fontSize: 26, fontWeight: 800, color: 'white', fontFamily: 'Syne, sans-serif', letterSpacing: '-0.02em' }}>
              1.25%
            </div>
            <span style={{
              fontSize: 11,
        ...
        {/* Asset Allocation */}
        <motion.div
          custom={6} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
        ...
        {/* Zero Hidden Fees */}
        <motion.div
          custom={7} variants={card} initial="hidden" animate={inView ? "visible" : "hidden"}
          style={{
            background: '#0d0d12',
            border: '1px solid rgba(255,255,255,0.07)',
            borderRadius: 14,
